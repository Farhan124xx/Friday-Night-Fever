...
class PlayState extends MusicBeatState {
	...
	public static var skip:FlxText;
	...
	override public function create() {
		...
		//}
	//	trace('Mod chart: ' + executeModchart + " - " + Main.path + Paths.lua(songToLowercase + "/modchart"));
	...
	//	}
		...
		switch (SONG.gfVersion) {
			...
			case 'gf-notea':
				gfVersion = 'gf-notea';
			case 'gfpainting':
				gfVersion = 'gfpainting';
			case 'gf-pixel':
				gfVersion = 'gf-pixel';
			case 'cherry-pixel':
				gfVersion = 'cherry-pixel';
			default:
				gfVersion = 'gf';
		}
	...
	override public function update(elapsed:Float) {
		...
		if (FlxG.keys.justPressed.ZERO) {
			FlxG.switchState(new AnimationDebug('bf-hallow-dead'));
			#if windows
			if (luaModchart != null) {
				luaModchart.die();
				luaModchart = null;
